 ...
 * Constructor.
******************************************************************************/
DoubleWellPotential::DoubleWellPotential() : PotentialBase() {
    strength = 1.0;
    loc = 1.0;
}

DoubleWellPotential::DoubleWellPotential(double _strength, double _loc) : PotentialBase() {
    strength = _strength;
    loc = _loc;
}
